...
export const products: Product[] = [
  {
    ...
    image:
      ...
      sku: "AFD620L",
      description: "AeroCool French Door Fridge with 620L capacity, inverter cooling, water dispenser, and frost-free storage.",
      stock: 8,
  },
  {
    id: "VM65OLED",
    ...
    image:
      ...
      sku: "VM65OLED",
      description: "VisionMax 65 inch OLED TV with 4K OLED panel, Dolby audio, gaming HDMI, and ultra-thin frame.",
      stock: 3,
  },
  {
    id: "PBP14",
    ...
    image:
      ...
      sku: "PBP14",
      description: "PulseBook Pro 14 with metal chassis, 16GB memory, 1TB SSD, and all-day battery.",
      stock: 12,
  },
  {
    id: "CMSC",
    ...
    image:
      ...
      sku: "CMSC",
      description: "ChefMate Smart Cooker with pressure, slow-cook, rice, steam, and saute presets.",
      stock: 18,
  },
  {
    id: "WPF12",
    ...
    image:
      ...
      sku: "WPF12",
      description: "WashPro 12kg Front Loader with steam wash, inverter motor, quick cycle, and fabric sensors.",
      stock: 4,
  },
  {
    id: "NXFP",
    ...
    image:
      ...
      sku: "NXFP",
      description: "Nova X Fold Phone with foldable display, pro cameras, 5G, and fast wireless charging.",
      stock: 0,
  },
];
